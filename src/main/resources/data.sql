...
INSERT INTO `building` VALUES (1,1,'TestName');
...
CREATE TABLE `reservation` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKoja8a2t4e96cn6kdx8k1t9o3w` (`desk_id`),
  KEY `FKtq5jyp5dqvp3d3oup0yj84cai` (`user_user_id`),
  CONSTRAINT `FKoja8a2t4e96cn6kdx8k1t9o3w` FOREIGN KEY (`desk_id`) REFERENCES `desk` (`id`),
  CONSTRAINT `FKtq5jyp5dqvp3d3oup0yj84cai` FOREIGN KEY (`user_user_id`) REFERENCES `users_table` (`user_id`)
...
INSERT INTO `reservations` VALUES (1,'2022-04-10',1,12345678),(2,'2022-04-10',2,12345678),(3,'2022-04-10',10,12345678),(4,'2022-04-11',4,12345678),(5,'2022-05-11',5,12345678),(6,'2022-04-30',2,12345678),(7,'2022-04-11',8,12345678),(8,'2022-04-11',12,12345678),(9,'2022-04-11',13,12345678);
...
INSERT INTO `users_table` VALUES (12345678,1,'update@email.com','updatedFirstName','updatedLastName','updatedMiddleName','updatedFirstName',0),(22222222,0,'update@email.com','updatedFirstName','updatedLastName','updatedMiddleName','updatedFirstName',0),(33333333,1,'update@email.com','updatedFirstName','updatedLastName','updatedMiddleName','updatedFirstName',0);
...
-- Dump completed on 2022-04-13 21:41:25
